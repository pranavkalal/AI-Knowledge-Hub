...
import { Search, Download, ExternalLink, Filter, X, FileText, Calendar, User, Tag } from "lucide-react";
                ...
                <div className="max-w-7xl mx-auto px-4 py-4">
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-3">
                            <Link href="/">
                                <img src="/logo.png" alt="CRDC Logo" className="h-8 w-auto" />
                            </Link>
                    ...
                    <form onSubmit={handleSearch} className="flex gap-2">
                        <div className="relative flex-1">
                            ...
                            <Input
                                ...
                                className="pl-10 h-12 text-lg rounded-xl bg-[#f0f4f9] border-none"
                            />
                        </div>
                        <Button
                            type="button"
                    ...
                    >
                        {documents.map((doc, index) => (
                            <motion.div key={index} variants={item}>
                                <Card className="h-full hover:shadow-lg transition-all duration-300 border-slate-200 hover:border-[#692080]/30 group">
                                    <CardHeader className="pb-2">
                                        <div className="flex items-start justify-between gap-2">
                                            <CardTitle className="text-base font-semibold text-slate-800 line-clamp-2 group-hover:text-[#692080] transition-colors">
                                                {doc.title}
                                            </CardTitle>
